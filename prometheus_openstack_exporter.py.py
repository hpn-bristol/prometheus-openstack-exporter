...
"""
"""
Some features related to VM diagnostics are added by the High Performance Lab,
University of Bristol.
For some purposes, the commands related to Cinder have been removed or commented.
For more info send email to: shadi.moazzeni@bristol.ac.uk
"""
...
#    def _get_nova_info(self, nova, cinder, prodstack):
    ...
    def _get_nova_info(self, nova, prodstack):
        info = {}
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                keystone, nova, neutron = get_clients()
                #keystone, nova, cinder = get_clients()

                prodstack.update(self._get_keystone_info(keystone))
                prodstack.update(self._get_neutron_info(neutron))
                prodstack.update(self._get_nova_info(nova, prodstack))
